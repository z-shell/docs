...
Uses feature(s): _setopt_, _source_, _zcompile_, _zmodload_
...
Has 191 line(s). Calls functions:

 .zi-module
 |-- is-at-least
 `-- zi.zsh/+zi-message

Uses feature(s): _autoload_, _is-at-least_, _source_
...
Uses feature(s): _setopt_, _zmodload_
...
Uses feature(s): _setopt_, _source_, _unfunction_
...
Has 401 line(s). Calls functions:
 ...
 |-- zi.zsh/+zi-message
 |-- zi.zsh/.zi-any-to-user-plugin
 `-- zi.zsh/.zi-run-plugin-standard-unload-callback
...
Has 281 line(s). Calls functions:
