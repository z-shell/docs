...
Has 367 line(s). Calls functions:
...
Called by:
 ...
 autoload.zsh/.zi-auto-reload
 autoload.zsh/.zi-cd
 autoload.zsh/.zi-check-comp-consistency
 autoload.zsh/.zi-clear-completions
 autoload.zsh/.zi-compiled
 autoload.zsh/.zi-confirm
 ...
 install.zsh/.zi-mirror-using-git
...
Has 177 line(s). Calls functions:
...
Has 98 line(s). Doesn't call other functions.
...
Has 79 line(s). *Is a precmd hook*. Calls functions:
...
Uses feature(s): _compinit_, _eval_, _setopt_, _source_
...
Uses feature(s): _autoload_, _compinit_, _zrecompile_
...
Has 249 line(s). Doesn't call other functions.

Uses feature(s): _getopts_, _setopt_, _zcompile_
