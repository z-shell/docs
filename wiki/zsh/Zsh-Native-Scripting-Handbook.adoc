...
ifdef::backend-html5[The handbook is also available as a link:https://github.com/z-shell/docs/wiki/zsh/Zsh-Native-Scripting-Handbook.pdf[PDF], link:https://z-shell.github.io/docs/zsh/Zsh-Native-Scripting-Handbook.html[HTML].]
