...
ifdef::backend-html5[The document is also available as a link:https://github.com/z-shell/docs/raw/main/wiki/zsh/Zsh-Plugin-Standard.pdf[PDF], link:https://z-shell.github.io/docs/zsh/Zsh-Plugin-Standard.html[HTML].]
