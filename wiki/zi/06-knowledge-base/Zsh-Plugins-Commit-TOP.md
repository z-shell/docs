...
- [path-ethic](https://github.com/sha1n/path-ethic) : :hourglass_flowing_sand: - Helps manage your `$PATH` quickly and easily. Doesn't touch your existing `.zshrc`, `.zprofile`, but adds on top of your existing environment instead.
...
- [syntax-highlighting](https://github.com/zsh-users/zsh-syntax-highlighting) :1st*place_medal: :hourglass_flowing_sand: - Add syntax highlighting to your ZSH. Make sure you load this \_before* zsh-users/zsh-history-substring-search or they will both break.
